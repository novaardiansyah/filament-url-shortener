...
class RolePolicy
{
  ...
  {
    return $user->checkPermissionTo('*') || $user->checkPermissionTo('delete-any Role');
  }
  ...
  {
    return $user->checkPermissionTo('*') || $user->checkPermissionTo('restore-any Role');
  }
  ...
  {
    return $user->checkPermissionTo('*') || $user->checkPermissionTo('replicate Role');
  }
  ...
  {
    return $user->checkPermissionTo('*') || $user->checkPermissionTo('reorder Role');
  }
  ...
  {
    return $user->checkPermissionTo('*') || $user->checkPermissionTo('force-delete-any Role');
  }
}
